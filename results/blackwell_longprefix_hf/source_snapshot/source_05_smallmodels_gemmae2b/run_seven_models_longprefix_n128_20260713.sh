...
RUN_ID=seven_models_longprefix_n128_20260713
SMOKE_ID=seven_models_longprefix_smoke_20260713
...
PENDING_MODEL=google/gemma-4-E2B-it
...
printf '%s\n' "${MODELS[@]}" "$PENDING_MODEL" > "$RESULTS/metadata/requested_models.txt"
printf '%s\n' "$PENDING_MODEL" > "$RESULTS/metadata/pending_models.txt"
